...
let ConfirmationURL = "http://197.248.117.74:3000/confirmation";
let ValidationURL = "http://197.248.117.74:3000/validation";
    ...
    return rp(
        {
            ...
            json:{
                ...
                "AccountReference": "GOOSELINKS2019",
                "TransactionDesc": " Mpesa to Sacco"                    
            }
        }
    ).then((body) => {    
        let json = {
